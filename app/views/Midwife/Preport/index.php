...
<div class="row justify-content-center mt-5 mb-2">
    ...
    <center>
        <h1 class="indexHead">ලියාපදිංචි මවුවරුන්</h1>
        ...
        <div class="row justify-content-center">
            <div class="sub-tab" id="midwifedetail" style="display: block;width: 100%;" style="font-size: small;">
                <nav class="navbar navbar-light" style="background-color: #d4d3cf;">
                    <form class="form-inline" style="display:block;width: 100%;" method="POST" action="<?= PROOT ?>/preport/selectedDataShow">
                        <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="idcardnum">

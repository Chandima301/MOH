...
<div style="background-color: #E8EAEE">
  ...
  <div style=" margin-top: 20px;" class="mother-table-box">
    <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" href="<?= PROOT ?>midwife/mother" id="pills-home-tab" role="tab" aria-controls="pills-home" aria-selected="true"><span style="color: black;">ලියාපදිංචි වූ මාතාවන්</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link mother-tab" href="<?= PROOT ?>midwife/request" role="tab" aria-selected="false"><span style="color: black;">ලියාපදිංචිය සදහා ඉල්ලීම්</span></a>
      </li>
    </ul>
